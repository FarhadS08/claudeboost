...
function LoginForm() {
  ...
  const redirect = searchParams.get("redirect") || "/org/new";
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        <div className="text-center mb-8">
          ...
          <p className="text-muted-foreground text-sm">Sign in to your team workspace</p>
        </div>

        {/* OAuth buttons (disabled until providers are configured in Supabase) */}
        <div className="space-y-2.5 mb-6">
          ...
          >
            ...
            Continue with Google <span className="text-[10px] text-zinc-600 ml-1">Coming soon</span>
          </button>
...
export default function LoginPage() {
  return (
    <Suspense fallback={<div className="min-h-screen flex items-center justify-center"><p className="text-muted-foreground animate-pulse">Loading...</p></div>}>
      <LoginForm />
    </Suspense>
  );
}
