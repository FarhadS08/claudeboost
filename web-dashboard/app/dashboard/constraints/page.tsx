        ...
        <div className="grid grid-cols-2 gap-2">
          {PRESETS.map((preset) => (
            <button
              ...
              className="text-left p-3 rounded-lg border border-zinc-700/30 hover:border-primary/40 hover:bg-primary/5 transition-colors group"
            >
